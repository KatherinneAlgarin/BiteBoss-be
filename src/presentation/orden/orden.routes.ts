...
export class OrdenRoutes {
  ...
  static get routes(): Router {
    ...
    router.get('/:id/historial-estados', (req, res) => controller.obtenerHistorialEstados(req, res));
    router.post('/', authorizeRoles('admin', 'cajero'), (req, res) => controller.crearOrden(req, res));
